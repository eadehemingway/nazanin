...
const MIN_TOTAL_GUTTER = (NO_OF_YEARS - 1) * MIN_YEAR_GUTTER;
...
const chart_width = (window_width * 0.55) - HORIZONTAL_SPACE;
...
export const YEAR_GUTTER = Math.max(MIN_YEAR_GUTTER, (chart_width - ((BOX_SIZE * DAY_COLUMNS) * NO_OF_YEARS)) / (NO_OF_YEARS - 1));
